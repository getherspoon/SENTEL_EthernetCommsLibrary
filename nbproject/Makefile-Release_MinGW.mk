...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libSENTEL_EthernetCommsLibrary.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libSENTEL_EthernetCommsLibrary.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -dynamiclib -install_name libSENTEL_EthernetCommsLibrary.${CND_DLIB_EXT} -fPIC

${OBJECTDIR}/AsyncConnectionlessReceiver.o: AsyncConnectionlessReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncConnectionlessReceiver.o AsyncConnectionlessReceiver.cpp

${OBJECTDIR}/AsyncConnectionlessSender.o: AsyncConnectionlessSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncConnectionlessSender.o AsyncConnectionlessSender.cpp

${OBJECTDIR}/AsyncMulticastComms.o: AsyncMulticastComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncMulticastComms.o AsyncMulticastComms.cpp

${OBJECTDIR}/AsyncMulticastCommsImpl.o: AsyncMulticastCommsImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncMulticastCommsImpl.o AsyncMulticastCommsImpl.cpp

${OBJECTDIR}/AsyncMulticastReceiver.o: AsyncMulticastReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncMulticastReceiver.o AsyncMulticastReceiver.cpp

${OBJECTDIR}/AsyncMulticastSender.o: AsyncMulticastSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncMulticastSender.o AsyncMulticastSender.cpp

${OBJECTDIR}/AsyncTCPComms.o: AsyncTCPComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncTCPComms.o AsyncTCPComms.cpp

${OBJECTDIR}/AsyncTCPCommsSendRecv.o: AsyncTCPCommsSendRecv.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncTCPCommsSendRecv.o AsyncTCPCommsSendRecv.cpp

${OBJECTDIR}/AsyncUDPComms.o: AsyncUDPComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncUDPComms.o AsyncUDPComms.cpp

${OBJECTDIR}/AsyncUDPCommsImpl.o: AsyncUDPCommsImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncUDPCommsImpl.o AsyncUDPCommsImpl.cpp

${OBJECTDIR}/AsyncUDPReceiver.o: AsyncUDPReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncUDPReceiver.o AsyncUDPReceiver.cpp

${OBJECTDIR}/AsyncUDPSender.o: AsyncUDPSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/AsyncUDPSender.o AsyncUDPSender.cpp

${OBJECTDIR}/CommsUtilities.o: CommsUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/CommsUtilities.o CommsUtilities.cpp

${OBJECTDIR}/EthernetCommsModule.o: EthernetCommsModule.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/EthernetCommsModule.o EthernetCommsModule.cpp

${OBJECTDIR}/NetworkUtilities.o: NetworkUtilities.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/NetworkUtilities.o NetworkUtilities.cpp

${OBJECTDIR}/SyncConnectionlessReceiver.o: SyncConnectionlessReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncConnectionlessReceiver.o SyncConnectionlessReceiver.cpp

${OBJECTDIR}/SyncConnectionlessSender.o: SyncConnectionlessSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncConnectionlessSender.o SyncConnectionlessSender.cpp

${OBJECTDIR}/SyncMulticastComms.o: SyncMulticastComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncMulticastComms.o SyncMulticastComms.cpp

${OBJECTDIR}/SyncMulticastCommsImpl.o: SyncMulticastCommsImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncMulticastCommsImpl.o SyncMulticastCommsImpl.cpp

${OBJECTDIR}/SyncMulticastReceiver.o: SyncMulticastReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncMulticastReceiver.o SyncMulticastReceiver.cpp

${OBJECTDIR}/SyncMulticastSender.o: SyncMulticastSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncMulticastSender.o SyncMulticastSender.cpp

${OBJECTDIR}/SyncTCPComms.o: SyncTCPComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncTCPComms.o SyncTCPComms.cpp

${OBJECTDIR}/SyncTCPCommsSendRecv.o: SyncTCPCommsSendRecv.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncTCPCommsSendRecv.o SyncTCPCommsSendRecv.cpp

${OBJECTDIR}/SyncUDPComms.o: SyncUDPComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncUDPComms.o SyncUDPComms.cpp

${OBJECTDIR}/SyncUDPCommsImpl.o: SyncUDPCommsImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncUDPCommsImpl.o SyncUDPCommsImpl.cpp

${OBJECTDIR}/SyncUDPReceiver.o: SyncUDPReceiver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncUDPReceiver.o SyncUDPReceiver.cpp

${OBJECTDIR}/SyncUDPSender.o: SyncUDPSender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/SyncUDPSender.o SyncUDPSender.cpp

${OBJECTDIR}/TCPComms.o: TCPComms.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/TCPComms.o TCPComms.cpp

${OBJECTDIR}/TCPCommsImpl.o: TCPCommsImpl.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/TCPCommsImpl.o TCPCommsImpl.cpp
